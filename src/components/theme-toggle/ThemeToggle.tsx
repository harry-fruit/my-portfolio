...
export const ThemeToggle = () => {
  ...
  return (
    <label className={style.themeToggleButton}>
      <input type="checkbox" className={style.toggle} onClick={toggle} />
      <svg
        viewBox="0 0 85 44"
      ...
      >
        <g transform="translate(3.5 3.5)" data-name="Component 15 – 1">
          ...
          <g transform="translate(2.333 2.333)" className={style.button}>
            <g data-name="sun" className={style.sun}>
              <g
              ...
              <circle
                ...
                cy="7"
                cx="7"
                className={style.sunInner}
              ></circle>
            </g>

            <g data-name="moon" className={style.moon}>
              <g
                filter="url(#moon)"
              ...
              <g
                transform="translate(-12.415 -1.009)"
                className={style.patches}
              >
                <circle
                ...
                ></circle>
                <circle
                  transform="translate(40.366 16.952)"
                  r="2"
                  cy="2"
                  cx="2"
                  data-name="patch"
                ></circle>
                <circle
                  transform="translate(36.016 10.044)"
                  r="1"
                  cy="1"
                  cx="1"
                  data-name="patch"
          ...
          >
            <path
              fill="#fff"
              transform="translate(-3457.47 -157.94)"
          ...
          >
            ...
            ></path>
            <path
              transform="translate(17.5 20.061) rotate(11)"
