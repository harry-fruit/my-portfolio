...
export const About: React.FC = (): JSX.Element => {
  return (
    <section id={"about"} className={`w-full py-12 px-2 md:px-6 md:py-16 lg:py-24 lg:px-20 xl:px-36 xl:py-44 2xl:px-52 2xl:py-52 ${style.aboutContainer}`}>
      ...
      <div id="text-wrapper" className={`${style.txt} flex flex-col justify-center gap-2 md:mt-4`}>
        ...
        <p className="text-center md:text-start text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias, quasi vitae perferendis commodi placeat molestiae sapiente delectus.</p>
      </div>
